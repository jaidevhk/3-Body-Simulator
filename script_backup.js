...
function updateGraphLabels() {
    ...
    if (yAxisLabel) {
        ...
        yAxisLabel.innerHTML = `Position (${minY}â€”${maxY})`;
    }
    ...
    if (xAxisLabel) {
        ...
        xAxisLabel.innerHTML = `Time (${minX}â€”${maxX})`;
    }
}
...
// Add a rotation angle variable for the main camera
let mainCameraRotationAngle = 0;
const CAMERA_ROTATION_SPEED = 0.002; // Rotation speed - very slow
